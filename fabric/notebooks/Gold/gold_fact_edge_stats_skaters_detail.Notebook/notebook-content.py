...
silver_edge_skaters_detail = spark.table("silver.fact_edge_stats_skaters_detail")
gold_players = spark.table("gold.dim_players")
gold_date = spark.table("gold.dim_date")

detail_with_date = silver_edge_skaters_detail.withColumn(
    "season_rep_date",
...
fact_edge_stats_skaters_detail = (
...
fact_edge_stats_skaters_detail.write.format("delta").mode("overwrite").saveAsTable("gold.fact_edge_stats_skaters_detail")
print(f"Table gold.fact_edge_stats_skaters_detail saved with {fact_edge_stats_skaters_detail.count()} rows!")
...
# --- Verification ---
row_count_check = silver_edge_skaters_detail.count() == fact_edge_stats_skaters_detail.count()
null_rate_check = fact_edge_stats_skaters_detail.select(
