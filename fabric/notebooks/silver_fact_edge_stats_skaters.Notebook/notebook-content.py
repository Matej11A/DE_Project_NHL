...
league_avr_metric_struct = StructType([
...
metric_value_struct = StructType([
    ...
    StructField("leagueAvr", league_avr_metric_struct, True)
])

bursts_struct = StructType([
    StructField("value", DoubleType(), True),
    StructField("percentile", DoubleType(), True),
    StructField("leagueAvr", StructType([
        StructField("value", DoubleType(), True)
    ]), True)
])
...
df_fact_edge_stats_skaters.write.format("delta").mode("overwrite").saveAsTable("silver.fact_edge_stats_skaters")
